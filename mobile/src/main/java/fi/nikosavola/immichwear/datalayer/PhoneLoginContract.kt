...
// Layer. Deliberately duplicated in :wear's own copy of this file rather than shared through a
// third module - see WatchLoginSender for why. kotlinx.serialization matches fields by name, so
...
/**
 * Best-effort library counts included with a successful [LoginResult] - null if the watch's
 * follow-up stats fetch failed, which never fails the login itself.
 */
